...
beforeEach(function() {
  ...
  // build small tree
  let nSmall = new TreeNode(1); // TreeNode { val: 1, children: [] }
  let nSmall2 = new TreeNode(2); // TreeNode { val: 2, children: [] }
  nSmall.children.push(nSmall2); // TreeNode { val: 1, children: [ TreeNode { val: 2, children: [] } ] }
  smallTree = new Tree(nSmall); // Tree { root: TreeNode { val: 1, children: [ [TreeNode] ] } }
  ...
  /** TreeNode {val: 1, children: [
     * TreeNode { val: 2, children: [] }, TreeNode { val: 3, children: [] }, TreeNode { val: 4, children: [] }
  * ]} */
  n4.children.push(n5, n6);
  n6.children.push(n7);
  n7.children.push(n8);

  largeTree = new Tree(n); // Tree {root: TreeNode { val: 1, children: [ [TreeNode], [TreeNode], [TreeNode] ] }}
});
